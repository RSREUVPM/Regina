public class Mashiny {
    ...
    public Mashiny(boolean legkovayaorgruzovaya, String benzinovij, int LoshadSil, int RazgonyaetsyaDoSta, int Tormozit, String bystroilimedlenno, boolean legkoilitrudno){
